...
function mapLead(row: any): ArtistLead {
  return {
    ...
    professionalEmail: row.professional_email ? String(row.professional_email) : null,
    phone: row.phone ? String(row.phone) : null,
    country: row.residence_country ? String(row.residence_country) : row.country ? String(row.country) : null,
    state: row.residence_state_region ? String(row.residence_state_region) : row.state ? String(row.state) : null,
    ...
    governmentId: row.government_id ? String(row.government_id) : null,
    nationality: row.nationality ? String(row.nationality) : null,
    residenceCity: row.residence_city ? String(row.residence_city) : null,
    residenceCountry: row.residence_country ? String(row.residence_country) : null,
    residenceStateRegion: row.residence_state_region ? String(row.residence_state_region) : null,
    ...
    representingCountry: row.representing_country ? String(row.representing_country) : null,
    managerName: row.manager_name ? String(row.manager_name) : null,
    managerEmail: row.manager_email ? String(row.manager_email) : null,
    managerPhone: row.manager_phone ? String(row.manager_phone) : null,
