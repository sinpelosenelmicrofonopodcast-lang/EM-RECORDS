      ...
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-6 py-4 md:px-10">
        ...
        <nav className="hidden items-center gap-6 md:flex">
          {navItems.map((item) => (
            <TrackedLink
              ...
              className="text-xs uppercase tracking-[0.2em] text-white/70 transition hover:text-gold"
            >
              {item.label}
            </TrackedLink>
          ))}
        ...
        <div className="flex items-center gap-3">
          ...
          <TrackedLink
            ...
            className="rounded-full border border-gold/50 px-4 py-2 text-[11px] uppercase tracking-[0.2em] text-gold hover:border-gold"
          >
            Admin
          </TrackedLink>
        </div>
